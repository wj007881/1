...
<div >
  ...
  <mt-button icon="more" slot="right" @click="more()"></mt-button>
    ...
    <div class="stories-header" v-if="stories.image">
      <div class="img-wrap">
        <h1 class="stories-title">{{stories.title}}</h1>
        <span class="img-source">{{stories.image_source}}</span>
        <div class="image-container" :style="{'background-image':`url(${stories.image})`}"></div>
